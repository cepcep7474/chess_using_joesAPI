                                ...
                                if (piece1Rank == 2) {
                                    if (((piece2Rank - piece1Rank) <= 2) && ((piece2Rank - piece1Rank) > 0)) {
                                        if ((piece1File - piece2File) == 0) {
                                            ...
                                            //remove color and pieceName from original square
                                            squares[i][0].classList.remove("white");
                                            squares[i][0].classList.remove("whitePawn");


                                            if (!isCheckmate()) {
                                                squareToCheckDoc[0].classList.remove("white");

                                                squares[i][0].classList.add("whitePawn");
                                                squares[i][0].classList.add("white");
